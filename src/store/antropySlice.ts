...
const chatSlice = createSlice({
  ...
  reducers: {
    ...
    updateMessage: (
      ...
      console.log("🚀 ~ updateMessage:", state);
    },
    updateSearch: (
      state,
      action: PayloadAction<{
      ...
      console.log("🚀 ~ updateSearch:", state);
    },
    // updateAnthropic: (
    //   state,
    //   action: PayloadAction<{
    //     threadId: string;
    //     chatIndex: number;
    //     anthropicResults: any;
    //   }>
    // ) => {
    //   const { threadId, chatIndex, anthropicResults } = action.payload;
    //   state.threads[threadId].chats[chatIndex].searchResults = anthropicResults;
    // },
    updateWeather: (
      state,
      action: PayloadAction<{
      ...
      console.log("🚀 ~ updateWeather:", state);
    },
    updateStock: (
      state,
      action: PayloadAction<{
    ...
    updateAnswer: (
      ...
      console.log("🚀 ~ updateAnswer:", state);
    },
    updateChatThread: (
      state,
      action: PayloadAction<{
...
export const selectChatThread = (state: RootState, threadId: string) =>
  state.antropy.threads[threadId];
