...
//   // const [anthropicResponse, setAnthropicResponse] = useState<string | null>(
//   //   null
//   // );
...
//   // const callAnthropicAPI = async (query: string) => {
//   //   try {
...
//   //     if (!response.ok) {
//   //       throw new Error("Failed to fetch Anthropic API response");
//   //     }

//   //     const data = await response.json();
//   //     return data;
//   //   } catch (error) {
//   //     console.error("Error fetching Anthropic API response:", error);
//   //     throw error;
//   //   }
//   // };
...
//         // Call Anthropic API
//         // const anthropicData = await callAnthropicAPI(chat?.question);
//         // dispatch(
//         //   updateAnthropic({
//         //     threadId: id,
//         //     chatIndex,
//         //     anthropicResults: anthropicData,
//         //   })
//         // );
//         return searchData;
//         // return { searchData, anthropicData };
//       } else {
...
import { addChat as AddAntropyChat } from "@/store/antropySlice";
import { Chat as ChatType } from "../../utils/types";
import { generateCitations } from "../../utils/utils";
import { handleMode } from "../../utils/api";
